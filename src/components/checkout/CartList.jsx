    ...
    <div className="lg:col-span-8 xl:col-span-9">
      <div className="space-y-4">
        <div className="space-y-1 rounded bg-white p-4 shadow-sm">
          ...
          <button className="!mt-4 inline-block underline">Edit</button>
        </div>
        {/* payment method */}
        <div className="space-y-1 rounded bg-white p-4 shadow-sm">
          ...
          <button to="/payment-method" className="!mt-4 inline-block underline">
            Edit
          </button>
        </div>
        <div className="space-y-5 rounded bg-white p-4 shadow-sm">
          ...
          <Link to="/cart" className="!mt-4 inline-block underline">
            Edit
          </Link>
        </div>
      </div>
